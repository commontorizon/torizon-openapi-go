...
// checks if the BadRequestRepr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BadRequestRepr{}
...
type _BadRequestRepr BadRequestRepr
...
func (o *BadRequestRepr) SetDescriptionNil() {
...
func (o *BadRequestRepr) SetCauseNil() {
	o.Cause.Set(nil)
}
...
func (o *BadRequestRepr) SetErrorIdNil() {
	o.ErrorId.Set(nil)
}
...
func (o *BadRequestRepr) UnmarshalJSON(data []byte) (err error) {
	...
	varBadRequestRepr := _BadRequestRepr{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBadRequestRepr)

	if err != nil {
		return err
	}

	*o = BadRequestRepr(varBadRequestRepr)

	return err
}

type NullableBadRequestRepr struct {
	value *BadRequestRepr
	isSet bool
}

func (v NullableBadRequestRepr) Get() *BadRequestRepr {
	return v.value
}

func (v *NullableBadRequestRepr) Set(val *BadRequestRepr) {
	v.value = val
	v.isSet = true
}
...
func NewNullableBadRequestRepr(val *BadRequestRepr) *NullableBadRequestRepr {
	return &NullableBadRequestRepr{value: val, isSet: true}
}
